                ...
                <div className='border-b bg-gray-900 border-gray-800 pt-3'>
                    <Navbar expand="lg" className='border-b-2 border-gray-900 pt-1 sticky-top'  >
                        <Col md={3}>
                            ...
                            <Link to="/">
                                <Navbar className="text-light align-self-center text-5xl border-gray-800 border-l-2 border-b-2 border-t-2 p-2">SpIcE </Navbar>
                            </Link>
                        </Col>
                        <Col md={9}>
                            ...
                            <Navbar.Collapse id="basic-navbar-nav " className=''>
                                ...
                                <Nav>
                                    ...
                                    <Nav.Link href="/profile" className="mx-1 text-light text-xs align-self-center border-yellow-800 border-b-2 rounded-full hover:bg-blue-800">Following  <Badge className=" bg-blue-600"> {totalNumOfMyFollowers > 0 ? totalNumOfMyFollowers : 0}</Badge> </Nav.Link>
                                    ...
                                    <Nav.Link href="/profile" className="mx-1 text-light text-xs align-self-center border-yellow-800 border-b-2 rounded-full hover:bg-blue-800">Followers (0)</Nav.Link>
                                    <Nav.Link>
